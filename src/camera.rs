...
impl Camera {
    ...
    pub fn viewport_height(self: &Self) -> f64 {
        2.0
    }
    pub fn viewport_width(self: &Self) -> f64 {
    ...
    pub fn delta_pixel_u(self: &Self) -> DVec3 {
        self.viewport_u() / (self.width as f64)
    }
    pub fn delta_pixel_v(self: &Self) -> DVec3 {
        self.viewport_v() / (self.height as f64)
    }
    pub fn viewport_upper_left(self: &Self) -> DVec3 {
        self.position
            - DVec3::new(0.0, 0.0, self.focal_length as f64)
            - self.viewport_u() / 2.0
            - self.viewport_v() / 2.0
    }
    pub fn pixel_00_loc(self: &Self) -> DVec3 {
